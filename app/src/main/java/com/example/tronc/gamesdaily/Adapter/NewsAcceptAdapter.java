...
public class NewsAcceptAdapter extends RecyclerView.Adapter<NewsAcceptAdapter.ViewHolder> {
    private List<News> mList;
    private Context mContext;
    private NewsAdapter.ViewHolder contactView;

    public NewsAcceptAdapter(Context mContext, List<News> mList) {
        this.mList = mList;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View views = inflater.inflate(R.layout.item_news_accept, viewGroup, false);
